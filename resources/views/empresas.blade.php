...
<div class="empresas-page" style="position: relative; z-index: 5; margin-top: -560px !important; margin-bottom:80px;background-color:var(--bg) ;opacity: 0.95; border-radius: 8px; border:1px solid var(--accent); justify-content:start;box-shadow:
