...
<head>
  ...
  <link rel="prefetch" as="image" href="{{ asset('img/cat/ingenieria.jpg') }}">
  <link rel="prefetch" as="image" href="{{ asset('img/cat/diseno.jpg') }}">
  <link rel="prefetch" as="image" href="{{ asset('img/cat/administracion.jpg') }}">
  <link rel="prefetch" as="image" href="{{ asset('img/cat/finanzas.jpg') }}">
  <link rel="prefetch" as="image" href="{{ asset('img/cat/marketing.jpg') }}">
  <link rel="prefetch" as="image" href="{{ asset('img/cat/recursos-humanos.jpg') }}">
  <link rel="prefetch" as="image" href="{{ asset('img/cat/tecnologia.jpg') }}">
  <link rel="prefetch" as="image" href="{{ asset('img/cat/ventas.jpg') }}">
  <link rel="prefetch" as="image" href="{{ asset('img/cat/industria-y-produccion.jpg') }}">
